## tiago_navigation (humble) - 4.12.0-1

The packages in the `tiago_navigation` repository were released into the `humble` distro by running `/usr/bin/bloom-release --track humble --rosdistro humble tiago_navigation -y` on `Wed, 11 Feb 2026 09:03:29 -0000`
...
## tiago_navigation (humble) - 4.11.0-1

The packages in the `tiago_navigation` repository were released into the `humble` distro by running `/usr/bin/bloom-release --track humble --rosdistro humble tiago_navigation -y` on `Tue, 13 May 2025 11:54:36 -0000`
...
## tiago_navigation (humble) - 4.9.0-1

The packages in the `tiago_navigation` repository were released into the `humble` distro by running `/usr/bin/bloom-release --track humble --rosdistro humble tiago_navigation -y` on `Fri, 07 Mar 2025 10:25:23 -0000`
...
## tiago_navigation (humble) - 4.5.0-1

The packages in the `tiago_navigation` repository were released into the `humble` distro by running `/usr/bin/bloom-release --track humble --rosdistro humble -y tiago_navigation` on `Mon, 11 Nov 2024 08:41:53 -0000`
...
The packages in the `tiago_navigation` repository were released into the `humble` distro by running `/usr/bin/bloom-release --track humble --rosdistro humble -y tiago_navigation` on `Fri, 13 Sep 2024 09:58:17 -0000`
